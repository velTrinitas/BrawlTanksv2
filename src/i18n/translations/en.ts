...
export const en: typeof pl = {
    ...
    'hub.garage.type.profileSkin': 'Profile skins', // v0.147.0
    ...
    // v0.147.0 — TANKER FACES pack
    'cosmetic.st_cool': 'Cool',
    'cosmetic.st_steam': 'Fired Up',
    'cosmetic.st_devil': 'Little Devil',
    'cosmetic.st_party': 'Winner',
    'cosmetic.st_rage': 'Furious',
    'cosmetic.st_mindblown': 'Mind Blown',
    ...
    // v0.147.0 — profile skins (hero banner)
    'cosmetic.ps_pixel': 'Pixel',
    'cosmetic.ps_angles': 'Angles',
    'cosmetic.ps_jackal': 'Jackal',
    'cosmetic.ps_mirage': 'Mirage',
    'cosmetic.ps_gale': 'Gale',
    'cosmetic.ps_stones': 'Stones',
    'cosmetic.ps_deep': 'Deep',
    'cosmetic.ps_blaze': 'Blaze',
    // v0.147.0 — SINGULAR category names (crate reward prefix).
    'cosmetic.cat.nickColor': 'Nick color',
    'cosmetic.cat.frame': 'Avatar frame',
    'cosmetic.cat.title': 'Title',
    'cosmetic.cat.sticker': 'Sticker',
    'cosmetic.cat.horn': 'Horn',
    'cosmetic.cat.voice': 'Commander voice',
    'cosmetic.cat.crosshair': 'Crosshair',
    'cosmetic.cat.avatarBg': 'Portrait background',
    'cosmetic.cat.profileSkin': 'Profile skin',
    ...
    'shop.tab.profileSkins': 'PROFILE SKINS',
    'shop.tab.avatars': 'AVATARS',
    'shop.tab.soon': 'SOON',
    ...
    'shop.item.profileSkin.desc': 'The background of your whole profile bar — everyone who visits you sees it.',
    'shop.item.soon_ps.name': 'Skin ?',
    'shop.item.soon_ps.desc': 'Another profile skin. Still in the works.',
    'shop.item.avatarSlot.name': 'Avatar ?',
    'shop.item.avatarSlot.desc': 'A new face for your profile. Still in the works.',
    ...
    'power.pong.desc': 'Paddles bounce enemy bullets back to their sender for 5 s.',
