...
export const en: typeof pl = {
    ...
    'leaderboard.tab.save_queen': 'Save the Queen',
    ...
    'hub.profile.tab.overview': 'Stats',
    ...
    'cosmetic.cat.tankSkin': 'Tank colors',
    'cosmetic.vo_commander': 'Commander',
    // SKIN-1 (v0.159.0): TANK COLORS (8 palettes)
    'cosmetic.ts_desert': 'Desert Sand',
    'cosmetic.ts_snow': 'Snow Patrol',
    'cosmetic.ts_bubblegum': 'Bubblegum',
    'cosmetic.ts_toxic': 'Toxic Lime',
    'cosmetic.ts_wave': 'Turquoise Wave',
    'cosmetic.ts_lava': 'Liquid Lava',
    'cosmetic.ts_night': 'Night Raid',
    'cosmetic.ts_sigma': 'Golden Sigma',
    // SKIN-2 (v0.160.0): PREMIUM PATTERNS + categories
    'cosmetic.tp_tiger': 'Tiger',
    'cosmetic.tp_cow': 'Cow',
    'cosmetic.tp_shark': 'Shark',
    'cosmetic.tp_dino': 'Dino Scale',
    'cosmetic.tp_panda': 'Panda',
    'cosmetic.tp_cobra': 'Cobra',
    'cosmetic.tp_woxel': 'Woxel',
    'cosmetic.tp_bricks': 'Bricks',
    'cosmetic.tp_retro': 'Retro 8-bit',
    'cosmetic.tp_glitch': 'Glitch',
    'cosmetic.tp_neongrid': 'Neon Grid',
    'cosmetic.tp_lowpoly': 'Low-Poly',
    'cosmetic.tp_lava': 'Living Lava',
    'cosmetic.tp_ice': 'Eternal Ice',
    'cosmetic.tp_ocean': 'Ocean',
    'cosmetic.tp_storm': 'Thunder',
    'cosmetic.tp_galaxy': 'Galaxy',
    'cosmetic.tp_slime': 'Slime',
    'cosmetic.tp_desert': 'Desert Storm',
    'cosmetic.tp_cadpat': 'CADPAT',
    'cosmetic.tp_m90': 'M90',
    'cosmetic.tp_woodland': 'Green Camo',
    'cosmetic.tp_winter': 'Winter Camo',
    'cosmetic.tp_navy': 'Navy Camo',
    'cosmetic.tp_s3_notebook': 'Checkered Notebook',
    'cosmetic.tp_s4_sweater': 'Festive Sweater',
    'cosmetic.tp_s5_penguin': 'Penguin Patrol',
    'cosmetic.tp_s6_hatchling': 'Hatchling',
    'cosmetic.tp_s7_grill': 'Grill Marks',
    'cosmetic.tp_s8_aloha': 'Aloha Shirt',
    'cosmetic.ts_mint': 'Minty Mist',
    'cosmetic.ts_choco': 'Chocolate Armor',
    'cosmetic.ts_indigo': 'Royal Indigo',
    'cosmetic.ts_fuchsia': 'Ultraviolet',
    'cosmetic.tskin.cat.all': 'All',
    'cosmetic.tskin.cat.palettes': 'Palettes',
    'cosmetic.tskin.cat.animals': 'Animals',
    'cosmetic.tskin.cat.games': 'Games',
    'cosmetic.tskin.cat.elements': 'Elements',
    'cosmetic.tskin.cat.military': 'Military',
    'cosmetic.tskin.cat.seasonal': 'Seasonal',
    'shop.item.tankPattern.desc': 'Premium armor pattern — visible in every match.',
    ...
    'power.tower': 'Tower',
    'hud.towerStart': '🗼 MG TOWER!',
    'power.rockets': 'Salvo',
    'hud.rocketsStart': '🚀 ROCKET SALVO!',
    'road.unlock.rockets': '🚀 Power: Rocket Salvo!',
    'power.ghost': 'Phantom',
    'hud.ghostStart': '👻 PHANTOM DECOY!',
    'power.mines': 'Mines',
    'hud.minesStart': '💥 MINES — DRIVE!',
    'road.unlock.mines': '💥 Power: Mines!',
    'power.build': 'Wall',
    'hud.buildStart': '🧱 WALL — DRIVE!',
    ...
    'brawler.twardy.desc': 'A solid tank for every occasion. It takes a beating, hits hard and keeps a steady rhythm — if you are not sure what to pick, start here.',
    'brawler.heavy.desc': 'A walking fortress with the thickest armour in the garage. It fires from two barrels at once and soaks up fire that would wreck any other tank. The price for that toughness is a slow reload.',
    'brawler.scout.desc': 'The fastest tank in the whole roster. It fires in rapid bursts and slips out of trouble before the enemy can even aim. It wins with movement and speed, never by trading blows.',
    'brawler.sniper.desc': 'A single accurate shot is enough to take down an ordinary enemy. It fires the least often of them all and reaches the furthest — punishing every enemy mistake from a safe distance.',
    'brawler.plasma.desc': 'Plasma rounds punch straight through and hit several enemies lined up behind each other. At its best when opponents come in a row rather than one by one.',
    ...
    'map.castleGrounds.name': 'GREEN VALLEY',
    'map.castleGrounds.tagline': 'A moated castle, six waves of raiders',
    'map.dungeon.name': 'DUNGEON',
    'map.dungeon.tagline': 'A cell underground, lava and Builders',
    // OBRON ZAMEK F3 — scenario messages
    'castle.intro': '🏰 DEFEND THE CASTLE! Waves are coming from the camps',
    'castle.waveStart': '⚔ WAVE {n}/{total}',
    'castle.waveCleared': '✅ WAVE {n} REPELLED!',
    'castle.buildPhase': '🔨 BUILD: {s}s — stand by a wall to repair',
    'castle.earlyStart': '⚡ EARLY! +{n}',
    'castle.gateDestroyed': '💥 GATE BROKEN!',
    'castle.wallBreached': '💥 WALL BREACHED!',
    'castle.keepCritical': '🔥 THE CASTLE IS BURNING!',
    'castle.respawnIn': '☠ RESPAWN IN {s}s',
    'castle.respawned': '🛡 BACK IN THE FIGHT',
    'castle.mega': '👑 THE SIEGE KING ARRIVES!',
    'castle.salvo': '🪨 STONE HAIL!',
    'castle.trebuchetDown': '💥 TREBUCHET DESTROYED! +{n}',
    'castle.hint1': '1/3 · Enemies march the ROAD to the GATE',
    'castle.hint2': '2/3 · Each of the 4 gates opens when you drive up — and only for you',
    'castle.hint3': '3/3 · Between waves STAND by a damaged wall = repair',
    'castle.repairHint': '🔨 STAND BY A DAMAGED WALL TO REPAIR',
    'castle.stopHint': 'STOP = REPAIR',
    // OBRON ZAMEK — scenario TUTORIAL (once per device)
    'castle.tut.title': '🏰 DEFENDER TRAINING',
    'castle.tut.step1': '1/4 · Drive up to the bottom GATE — it opens by itself',
    'castle.tut.step2': '2/4 · Cross the BRIDGE over the moat and come back inside',
    'castle.tut.step3': '3/4 · Scouts incoming! Destroy 3 enemies — they march the ROAD to the gate',
    ...
    'hud.castle.keep': 'CASTLE',
    'hud.castle.gate': 'GATES',
    'hud.castle.gateBroken': 'ALL BROKEN',
    'hud.castle.intro': '🏰 GET READY: {s}s',
    'hud.castle.wave': '⚔ WAVE {n}/{total} · enemies: {left}',
    'hud.castle.build': '🔨 BUILD {s}s',
    'hud.castle.allWaves': '✅ ALL WAVES REPELLED!',
    'hud.castle.defeat': '💀 THE CASTLE HAS FALLEN',
    'hud.castle.respawn': 'RESPAWN IN',
    'hud.castle.nextWave': '⚔ NEXT WAVE',
    'hud.castle.tutorial': '🏰 DEFENDER TRAINING',
    'goal.castle': 'Defend the castle through 6 waves! Enemies march the road to the gate — repair the wall between waves.',
    ...
    'queen.keystoneBroken': 'KEYSTONE SHATTERED!',
    'queen.heart': 'Queen: "Hold on!" ❤️',
    'queen.rescued': 'RESCUED!',
    'queen.captured': 'TAKEN!',
    'queen.destroyed': 'TANK DESTROYED!',
    'queen.flex.lastSecond': 'LAST SECOND! +50',
    'queen.boss': 'BOSS COMING THROUGH THE GATE!',
    'queen.builder': 'BUILDER! Rebuilding the wall!',
    'queen.builderDown': 'BUILDER DOWN +10',
    'queen.rebuilt': 'Wall regrowing - path set back!',
    'queen.dynamite': 'DYNAMITE! Run!',
    'queen.blast': 'BOOM!',
    'queen.geyser': 'GEYSERS! Mind the grates!',
    'queen.lava': 'Lava burns!',
    'queen.tower': 'SINISTER TOWER! Beware the green fire!',
    'queen.towerDown': 'TOWER DESTROYED! +200',
    'queen.key.found': 'GOLDEN KEY! Open the cell door!',
    'queen.key.need': 'Door locked - find the GOLDEN KEY!',
    'queen.key.hud': 'You have the key',
    'queen.door.open': 'DOOR OPEN! To the Queen!',
    'queen.ready': 'GET READY!',
    'queen.tut.title': 'RESCUER TRAINING',
    'queen.tut.1.title': 'BRICK!',
    'queen.tut.1.hint': 'Drive to the WALL in the east and break a brick - shoot it',
    'queen.tut.2.title': 'KEYSTONE!',
    'queen.tut.2.hint': 'The violet rune only breaks from a SUPER - battery is full, shoot!',
    'queen.tut.3.title': 'KEY!',
    'queen.tut.3.hint': 'The cell door is locked - find the GOLDEN KEY (arrow)',
    'queen.tut.4.title': 'WALL REGROWS!',
    'queen.tut.4.hint': 'Orange ghost = a brick is coming back. Break the regrowing brick!',
    'queen.tut.5.title': 'DOOR!',
    'queen.tut.5.hint': 'Bring the key to the STEEL DOOR of the cell',
    'queen.tut.step1': '1/5 - Drive to the WALL in the east and break a brick (shoot)',
    'queen.tut.step2': '2/5 - The KEYSTONE (violet rune) only breaks from a SUPER - battery is full, shoot it!',
    ...
    'hud.queen.key': 'KEY',
    'hud.queen.path': 'PATH',
    'queen.end.rescued.title': 'RESCUED!',
    'queen.end.rescued.subtitle': 'The Queen is safe. {s} s to spare!',
    'queen.end.captured.title': 'TAKEN!',
    'queen.end.destroyed.title': 'TANK DESTROYED!',
    'queen.end.captured.timeout': 'They took her at the last moment...',
    'queen.end.captured.death': 'You did not make it in time...',
    'queen.end.bricks': 'Bricks',
    'queen.end.rescueTime': 'Time left',
    'end.waves': 'Waves',
    'end.deaths': 'Deaths',
