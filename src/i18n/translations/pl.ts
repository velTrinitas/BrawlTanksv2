...
export const pl = {
    ...
    'leaderboard.tab.save_queen': 'Uratuj Królową',
    ...
    'hub.profile.tab.overview': 'Statystyki',
    ...
    'cosmetic.cat.tankSkin': 'Barwy czołgu',
    'cosmetic.vo_commander': 'Dowódca',
    // ── SKIN-1 (v0.159.0): BARWY CZOŁGU (8 palet) ──
    // SKIN-2: nazwa "Pustynna Burza" oddana wzorowi tp_desert (efektowniejsza
    // nazwa dla efektowniejszej rzeczy); paleta zostaje pod tym samym id.
    'cosmetic.ts_desert': 'Pustynny Piach',
    'cosmetic.ts_snow': 'Śnieżny Patrol',
    'cosmetic.ts_bubblegum': 'Guma Balonowa',
    'cosmetic.ts_toxic': 'Toksyczna Limonka',
    'cosmetic.ts_wave': 'Turkusowa Fala',
    'cosmetic.ts_lava': 'Płynna Lawa',
    'cosmetic.ts_night': 'Nocny Rajd',
    'cosmetic.ts_sigma': 'Złoty Sigma',
    // ── SKIN-2 (v0.160.0): WZORY PREMIUM + kategorie ──
    'cosmetic.tp_tiger': 'Tygrys',
    'cosmetic.tp_cow': 'Krowa',
    'cosmetic.tp_shark': 'Rekin',
    'cosmetic.tp_dino': 'Dino Łuska',
    'cosmetic.tp_panda': 'Panda',
    'cosmetic.tp_cobra': 'Kobra',
    'cosmetic.tp_woxel': 'Woxel',
    'cosmetic.tp_bricks': 'Klocki',
    'cosmetic.tp_retro': 'Retro 8-bit',
    'cosmetic.tp_glitch': 'Glitch',
    'cosmetic.tp_neongrid': 'Neon Grid',
    'cosmetic.tp_lowpoly': 'Low-Poly',
    'cosmetic.tp_lava': 'Żywa Lawa',
    'cosmetic.tp_ice': 'Wieczny Lód',
    'cosmetic.tp_ocean': 'Ocean',
    'cosmetic.tp_storm': 'Piorun',
    'cosmetic.tp_galaxy': 'Galaktyka',
    'cosmetic.tp_slime': 'Slime',
    'cosmetic.tp_desert': 'Pustynna Burza',
    'cosmetic.tp_cadpat': 'CADPAT',
    'cosmetic.tp_m90': 'M90',
    'cosmetic.tp_woodland': 'Moro Zielone',
    'cosmetic.tp_winter': 'Moro Zimowe',
    'cosmetic.tp_navy': 'Moro Niebieskie',
    'cosmetic.tp_s3_notebook': 'Zeszyt w Kratkę',
    'cosmetic.tp_s4_sweater': 'Świąteczny Sweter',
    'cosmetic.tp_s5_penguin': 'Pingwiński Patrol',
    'cosmetic.tp_s6_hatchling': 'Wyklute Jajo',
    'cosmetic.tp_s7_grill': 'Kratka z Grilla',
    'cosmetic.tp_s8_aloha': 'Hawajska Koszula',
    'cosmetic.ts_mint': 'Miętowa Mgła',
    'cosmetic.ts_choco': 'Czekoladowy Pancerz',
    'cosmetic.ts_indigo': 'Królewski Indygo',
    'cosmetic.ts_fuchsia': 'Ultrafiolet',
    'cosmetic.tskin.cat.all': 'Wszystkie',
    'cosmetic.tskin.cat.palettes': 'Palety',
    'cosmetic.tskin.cat.animals': 'Zwierzęta',
    'cosmetic.tskin.cat.games': 'Gry',
    'cosmetic.tskin.cat.elements': 'Żywioły',
    'cosmetic.tskin.cat.military': 'Wojskowe',
    'cosmetic.tskin.cat.seasonal': 'Sezonowe',
    'shop.item.tankPattern.desc': 'Wzór premium na pancerz — widoczny w każdym meczu.',
    ...
    'power.tower': 'Wieża',
    'hud.towerStart': '🗼 WIEŻA MG!',
    'power.rockets': 'Salwa',
    'hud.rocketsStart': '🚀 SALWA RAKIET!',
    'road.unlock.rockets': '🚀 Moc: Salwa Rakiet!',
    'power.ghost': 'Widmo',
    'hud.ghostStart': '👻 WIDMO ZWODZI!',
    'power.mines': 'Miny',
    'hud.minesStart': '💥 MINY — JEDŹ!',
    'road.unlock.mines': '💥 Moc: Miny!',
    'power.build': 'Mur',
    'hud.buildStart': '🧱 MUR — JEDŹ!',
    ...
    'brawler.twardy.desc': 'Solidny czołg na każdą okazję. Wytrzymuje sporo, bije mocno i strzela równo — jeśli nie wiesz, czym zagrać, zacznij właśnie nim.',
    'brawler.heavy.desc': 'Chodząca forteca z najgrubszym pancerzem w garażu. Strzela z dwóch luf naraz i wchłania ostrzał, który rozłożyłby każdy inny czołg. Za tę wytrzymałość płaci powolnym przeładowaniem.',
    'brawler.scout.desc': 'Najszybszy czołg w całej stawce. Strzela seriami jak z karabinu i wymyka się z opresji, zanim wróg zdąży wycelować. Wygrywa ruchem i tempem, nie wymianą ciosów.',
    'brawler.sniper.desc': 'Jeden celny strzał wystarcza, żeby rozłożyć zwykłego wroga. Strzela najrzadziej z całej stawki i sięga najdalej — karze każdy błąd przeciwnika z bezpiecznej odległości.',
    'brawler.plasma.desc': 'Pociski plazmowe przebijają na wylot i trafiają kilku wrogów ustawionych w jednej linii. Najlepszy, gdy przeciwnicy nadciągają szeregiem, a nie pojedynczo.',
    ...
    'map.castleGrounds.name': 'ZIELONA DOLINA',
    'map.castleGrounds.tagline': 'Zamek nad fosą, sześć fal najeźdźców',
    'map.dungeon.name': 'LOCHY',
    'map.dungeon.tagline': 'Cela w podziemiach, lawa i Budowniczowie',
    // OBRON ZAMEK F3 — komunikaty scenariusza
    'castle.intro': '🏰 BROŃ ZAMKU! Fale nadciągają z obozów',
    'castle.waveStart': '⚔ FALA {n}/{total}',
    'castle.waveCleared': '✅ FALA {n} ODPARTA!',
    'castle.buildPhase': '🔨 BUDOWA: {s}s — stań przy murze, by naprawiać',
    'castle.earlyStart': '⚡ WCZEŚNIEJ! +{n}',
    'castle.gateDestroyed': '💥 BRAMA WYŁAMANA!',
    'castle.wallBreached': '💥 WYŁOM W MURZE!',
    'castle.keepCritical': '🔥 ZAMEK PŁONIE!',
    'castle.respawnIn': '☠ ODRODZENIE ZA {s}s',
    'castle.respawned': '🛡 WRACASZ DO WALKI',
    'castle.mega': '👑 KRÓL OBLĘŻENIA NADCIĄGA!',
    'castle.salvo': '🪨 GRAD KAMIENI!',
    'castle.trebuchetDown': '💥 TREBUCHET ZNISZCZONY! +{n}',
    'castle.hint1': '1/3 · Wrogowie idą DROGĄ na BRAMĘ',
    'castle.hint2': '2/3 · Każda z 4 bram otwiera się, gdy podjedziesz — i tylko dla Ciebie',
    'castle.hint3': '3/3 · Między falami STAŃ przy uszkodzonym murze = naprawa',
    'castle.repairHint': '🔨 STAŃ PRZY USZKODZONYM MURZE, BY NAPRAWIAĆ',
    'castle.stopHint': 'STÓJ = NAPRAWA',
    // OBRON ZAMEK — TUTORIAL scenariusza (raz per urzadzenie)
    'castle.tut.title': '🏰 SZKOLENIE OBROŃCY',
    'castle.tut.step1': '1/4 · Podjedź do BRAMY na dole — otworzy się sama',
    'castle.tut.step2': '2/4 · Wyjedź MOSTEM za fosę i wróć do środka',
    'castle.tut.step3': '3/4 · Nadciąga zwiad! Zniszcz 3 wrogów — idą DROGĄ na bramę',
    ...
    'hud.castle.defeat': '💀 ZAMEK UPADŁ',
    'hud.castle.respawn': 'ODRODZENIE ZA',
    'hud.castle.nextWave': '⚔ NASTĘPNA FALA',
    'hud.castle.tutorial': '🏰 SZKOLENIE OBROŃCY',
    'goal.castle': 'Broń zamku przez 6 fal! Wrogowie idą drogą na bramę — naprawiaj mur między falami.',
    ...
    'queen.keystoneBroken': 'ZWORNIK PĘKŁ!',
    ...
    'queen.builder': 'BUDOWNICZY! Odbudowuje mur!',
    'queen.builderDown': 'BUDOWNICZY ✕ +10',
    'queen.rebuilt': 'Mur odrasta — droga cofnięta!',
    'queen.dynamite': 'DYNAMIT! Uciekaj!',
    'queen.blast': 'WYBUCH!',
    'queen.geyser': 'GEJZERY! Uważaj na kraty!',
    'queen.lava': 'Lawa parzy!',
    'queen.tower': 'ZŁOWROGA WIEŻA! Uważaj na zielony ogień!',
    'queen.towerDown': 'WIEŻA ZBURZONA! +200',
    'queen.key.found': 'ZŁOTY KLUCZ! Otwórz drzwi celi!',
    'queen.key.need': 'Drzwi zamknięte — znajdź ZŁOTY KLUCZ!',
    'queen.key.hud': 'Masz klucz 🔑',
    'queen.door.open': 'DRZWI OTWARTE! Do Królowej!',
    'queen.ready': 'GOTUJ SIĘ!',
    'queen.tut.title': '👸 SZKOLENIE RATOWNIKA',
    'queen.tut.1.title': 'CEGŁA!',
    'queen.tut.1.hint': 'Jedź do MURU na wschodzie i rozbij cegłę — strzelaj w nią',
    'queen.tut.2.title': 'ZWORNIK!',
    'queen.tut.2.hint': 'Fioletowa runa pęka tylko od SUPERA — masz pełną baterię, strzel!',
    'queen.tut.3.title': 'KLUCZ!',
    'queen.tut.3.hint': 'Drzwi celi są zamknięte — znajdź ZŁOTY KLUCZ (strzałka 🔑)',
    'queen.tut.4.title': 'MUR ODRASTA!',
    'queen.tut.4.hint': 'Pomarańczowy duch = cegła wraca. Rozbij odrastającą cegłę!',
    'queen.tut.5.title': 'DRZWI!',
    'queen.tut.5.hint': 'Podjedź z kluczem do STALOWYCH DRZWI celi',
    'queen.tut.step1': '1/5 · Jedź do MURU na wschodzie i rozbij cegłę (strzelaj)',
    'queen.tut.step2': '2/5 · ZWORNIK (fioletowa runa) pęka tylko od SUPERA — masz pełną baterię, strzel w niego!',
