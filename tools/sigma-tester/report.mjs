...
function pickShots() {
    const score = (r, s) => (r.violations?.length ? 40 : 0) + (r.mobile ? 30 : 0) + (/-hud\.png$/.test(s) ? 25 : /-(death|shot)\.png$/.test(s) ? 20 : /-end\.png$/.test(s) ? 15 : /-(timeout|error|portrait)\.png$/.test(s) ? 10 : 2);
